...
## Editorial and privacy addendum — 23 September 2026

The updated product brief and surface direction supersede the earlier location-led framing. Public copy presents an anonymous House Core demonstration project. The home's real address must remain absent from public text, filenames, metadata and downloadable packages; historical internal document names do not authorize its reuse. The cover, image alternative text and source note now use the anonymous framing, while preserving the distinction between a project visualization, completed work and the separate synthetic PDF example.

The H1 is now “Strisce LED Torino: illuminazione a soffitto e domotica”; the page title is “Strisce LED Torino: soffitto e domotica | Lostar”. The index and main section headings foreground “Strisce LED Torino”, with specific topics covering ceiling coves and plasterboard, lighting scenes and home automation, materials and power supplies, House Core PDF layers, quotations and questions. H3s name the practical subjects within those sections, including aluminium profiles, dimming, WLED and controllers, voltage drop and maintenance access. The canonical URL and seven-section reading structure remain the same.

This addendum was checked against the updated PRODUCT.md, surface direction and current article markup, with the existing DESIGN.md and sidecar as visual references. It records a copy and privacy correction: the established visual identity, CSS and global design records are preserved. No independent screenshot or deployment verification is claimed by this documentation pass.
